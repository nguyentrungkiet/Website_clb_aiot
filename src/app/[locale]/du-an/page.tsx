      ...
      <main className="flex min-h-screen flex-col bg-white dark:bg-card">
        ...
        <section className="py-16 container mx-auto px-4 md:px-6">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projectIds.map((idx) => (
              <div key={idx} className="group rounded-2xl border border-border bg-white dark:bg-card overflow-hidden shadow-sm hover:shadow-xl transition-all">
                ...
                <div className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-foreground mt-2 mb-3">{t(`items.${idx}.name`)}</h3>
                  <p className="text-gray-600 dark:text-gray-300 mb-4">{t(`items.${idx}.desc`)}</p>
