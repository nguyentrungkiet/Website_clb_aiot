            ...
            {competitionIds.map((idx) => {
              ...
              return (
                <div key={idx} className="mb-12 ml-8 md:ml-12 relative">
                  <div className="absolute -left-[45px] md:-left-[63px] top-0 h-10 w-10 md:h-12 md:w-12 rounded-full bg-[#1767A6] border-4 border-background flex items-center justify-center text-white">
                  ...
                  <div className="bg-white dark:bg-card p-6 rounded-2xl shadow-sm border border-border hover:shadow-md transition">
                    ...
                    <div className="mt-4 inline-block bg-background text-[#1767A6] px-4 py-1.5 rounded-full font-bold text-sm">
