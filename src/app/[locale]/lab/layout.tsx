...
import { LogoutButton } from "@/components/lab/LogoutButton";
...
export default async function LabLayout({
  ...
  // Changed cookie name to force invalidation of old 30-day cookies
  const isAuthenticated = cookieStore.get('lab_access_session')?.value !== undefined;
    ...
    <>
      ...
      <div className="border-b border-border bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex overflow-x-auto py-3 gap-6 text-sm font-medium hide-scrollbar items-center justify-between">
