        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-8 items-center">
          <div className="flex flex-col justify-center space-y-8">
            <div className="space-y-4">
              <h1 className="text-balance text-4xl font-bold tracking-tight text-foreground sm:text-5xl xl:text-6xl/tight">
                {t("headline")}
              </h1>
          ...
          <div className="relative mx-auto w-full max-w-[500px] lg:max-w-none">
            <div className="aspect-square rounded-2xl bg-white dark:bg-card p-2 shadow-xl border border-border relative overflow-hidden group">
