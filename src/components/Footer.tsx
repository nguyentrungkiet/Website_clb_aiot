...
export function Footer() {
  ...
  return (
    <footer className="w-full bg-white dark:bg-card border-t border-border pt-16 pb-8">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid gap-12 md:grid-cols-3 lg:grid-cols-4 lg:gap-8">
          ...
          <div className="space-y-4">
            <h4 className="text-lg font-bold text-foreground">{t("contact")}</h4>
        ...
        <div className="mt-16 pt-8 border-t border-border text-center text-sm text-gray-400">
